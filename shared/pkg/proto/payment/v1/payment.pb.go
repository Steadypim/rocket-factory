...
const (
	// PAYMENT_METHOD_UNKNOWN неизвестный способ оплаты.
	PaymentMethod_PAYMENT_METHOD_UNKNOWN PaymentMethod = 0
	// PAYMENT_METHOD_CARD оплата банковской картой.
	...
	// PAYMENT_METHOD_INVESTOR_MONEY оплата деньгами инвестора.
...
const file_payment_v1_payment_proto_rawDesc = "" +
	...
	"\bPayOrder\x12\x1b.payment.v1.PayOrderRequest\x1a\x1c.payment.v1.PayOrderResponseBVZTgithub.com/Steadypim/rocket-factory/workspace/shared/pkg/proto/payment/v1;payment_v1b\x06proto3"
