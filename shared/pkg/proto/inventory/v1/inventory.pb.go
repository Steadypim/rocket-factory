...
type ListPartsRequest struct {
	...
	ManufacturerCountries []string               `protobuf:"bytes,4,rep,name=manufacturer_countries,json=manufacturerCountries,proto3" json:"manufacturer_countries,omitempty"`
	Tags                  []string               `protobuf:"bytes,5,rep,name=tags,proto3" json:"tags,omitempty"`
	Filter                *PartsFilter           `protobuf:"bytes,6,opt,name=filter,proto3" json:"filter,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *ListPartsRequest) GetNames() []string {
	if x != nil {
		return x.Names
	}
	return nil
...
func (x *ListPartsRequest) GetCategories() []Category {
	if x != nil {
		return x.Categories
	}
	return nil
...
func (x *ListPartsRequest) GetManufacturerCountries() []string {
	if x != nil {
		return x.ManufacturerCountries
	}
	return nil
...
func (x *ListPartsRequest) GetTags() []string {
	if x != nil {
		return x.Tags
	}
	return nil
...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	...
	"\x04tags\x18\x05 \x03(\tR\x04tags\"\xf4\x01\n" +
	...
	"\x06filter\x18\x06 \x01(\v2\x19.inventory.v1.PartsFilterR\x06filter\"=\n" +
	...
	"\tListParts\x12\x1e.inventory.v1.ListPartsRequest\x1a\x1f.inventory.v1.ListPartsResponseBZZXgithub.com/Steadypim/rocket-factory/workspace/shared/pkg/proto/inventory/v1;inventory_v1b\x06proto3"
...
var file_inventory_v1_inventory_proto_depIdxs = []int32{
	...
	0,  // 8: inventory.v1.ListPartsRequest.categories:type_name -> inventory.v1.Category
	7,  // 9: inventory.v1.ListPartsRequest.filter:type_name -> inventory.v1.PartsFilter
	...
	5,  // 12: inventory.v1.InventoryService.GetPart:input_type -> inventory.v1.GetPartRequest
	8,  // 13: inventory.v1.InventoryService.ListParts:input_type -> inventory.v1.ListPartsRequest
	6,  // 14: inventory.v1.InventoryService.GetPart:output_type -> inventory.v1.GetPartResponse
